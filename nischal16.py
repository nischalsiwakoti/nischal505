"""
//DECOMPILED BY NISCHAL X SHIWAKOTI
@@FACEBOOK : Ni sc hal
"""
...
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
#os.system('xdg-openhttps://chat.whatsapp.com/DN5gBJnafyZAceDOQWrx4E' )
def clear():
        os.system('clear')
        print(logo)
A = '\x1b[1;97m' 
...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome NISCHAL xd Tool\33[0;m');linex()
...
def main_apv():
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20MAFIA%20Owner%20YOUSIF%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+977976900020?text='+tks)
        main_apv()
menu()
